...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Dev-MHM/XUser"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "XUser")
    ...
    # Google Drive plugin https://graph.org/G-Drive-guide-for-XUser-01-01
    ...
    BADCAT_REPO = os.environ.get("BADCAT_REPO", "https://github.com/Dev-MHM/XUserp")
    if BADCAT_REPO and not url(BADCAT_REPO):
        BADCAT_REPO = "https://github.com/Dev-MHM/XUserp"
